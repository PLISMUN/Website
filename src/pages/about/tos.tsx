  ...
  return (
    <Container maxW="110ch">
      <Text>
        ...
        International School is collectively referred to as 'we' or 'us', with all
      ...
      <ol type="a">
        ...
        <ol type="i">
          <li>
            <Text>
              Waive any and all claims against PLISMUN and Park Lane International
      ...
      <ol type="a">
        <li>
          <Text>
            Conference fees must be paid in full prior to the conference (within two weeks of application submission)
          </Text>
        </li>
        <li>
          <Text>
