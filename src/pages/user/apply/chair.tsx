...
function Signup({ committees, delegations }: ChairAppProps) {
  ...
  if (userData.application && !userData.extraData) {
    return (
      <Container maxW="110ch">
        ...
        <br />
        <Text>
          An error occured whilst fetching information about your application, please contact plismun@parklane-is.com
        </Text>
        <Text>
  ...
  return (
    <Container maxW="110ch">
      ...
      <br />
      <Text>
        Please note that this application is the first stage for becoming a chair 
        at PLISMUN '25.
      </Text>
          <br /> 
      <Text>
      ...
      {success && (
        <>
          <Heading>You have successfully applied to be a chair. If you do not receive an email within 5 minutes please contact plismun@parklane-is.com</Heading>
          <br />
          <Text>
      ...
      {!success && (
        <form onSubmit={handleSubmit}>
          ...
          >
            ...
            <GridItem area="motivation">
              ...
              >
                ...
                <FormHelperText>
                  ...
                  PLISMUN as a chair here (approx. 200 words)
                </FormHelperText>
              </FormControl>
            </GridItem>
            ...
            {/* shirt description */}
            <GridItem area="text">
              <Text>If you do not want a shirt please select "none". If you do want a shirt please select your shirt size.</Text>
            <br />
          ...
          <Center>
            <Button type="submit">Submit chair application</Button>
          </Center>
          <br />
          <Center>
