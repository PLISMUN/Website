...
import { sendChairEmail, sendChairEmailRedo, sendChairEmailStaffing } from "@/utils/mail"
...
handler.put(
  ...
  async (req: ApiRequest, res) => {
    ...
    await sendChairEmailRedo(req.user, newApplication, committees, delegation)
    await sendChairEmailStaffing(req.user, newApplication, committees, delegation)
