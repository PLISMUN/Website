    ...
    return (
        <footer className="bg-muted py-16">
            <div className="mx-auto max-w-5xl px-6">
                ...
                <span className="text-muted-foreground block text-center text-sm"> © {new Date().getFullYear()} Tomáš Stoklásek for the use by Park Lane International School <br />Made by <a className='underline' href='https://stoklasek.org/'>Tomáš Stoklásek</a>, Maintained by Tomáš Stoklásek</span>
            </div>
        </footer>
    )
}
