...
const members = [
    ...
    { src: '/people/tomas.jpeg', name: 'Tomáš Stoklásek ', role: 'Head of IT, Website & Logistics', description: 'Heya! I am Tomas (or Milo) and this year I am in charge of rewriting and upkeep our online systems (aka website design, programming, databases, etc. Full stack development) as well as helping with general managment & logistics. I hold myself to the same standards as the Prague city officials, so expect any bug fixes to come in 5-47 business days :3.  This is my second year in the organising team, however I have been active in the MUN community for a while, pocketing myself a best delegate award even though I usually try to focus on creating funny moments. Apart from MUN, you can find me hanging out with friends, programming, or watching House M.D with the occasional video game or game of tennis. I really hope that the conference will go well with as little tech issues as possible, fingers crossed. See you there and enjoy!' },
