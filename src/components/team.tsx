...
const members = [
  ...
  { src: '/logo.png', name: 'Mia Wilkinson', role: 'Head of Design and Merchandise', description: `Hey everyone! I’m Mia Wilkinson, and I’m head of design for PLISMUN 27. This is my second year of being involved in MUN. I've attended 6 MUN’s in the past, 5 of them being local and 1 of them being an international one. My favorite part of MUN is the fact that you meet so many new people from different schools, or even countries/cities. Outside of MUN, I enjoy baking, painting, and spending time with my amazing friends. I hope your PLISMUN experience will be fruitful and entertaining, carving it into your mind as one of the best weekends of your year, can’t wait to see you all!:)` },
