          ...
          <Card className="p-8 sm:p-12">
            ...
            {Object.keys(users).length > 0 ? (
              Object.values(users).map((user) => (
                <div key={user.userId} className={`border rounded-lg p-4 mb-4 ${user.pending ? "bg-yellow-50" : "bg-white-100"} shadow-sm`} data-pending={user.pending} data-paid={user.paymentStatus === "Completed"} data-role={user.role}>
