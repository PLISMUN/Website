                    ...
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p><strong>Payment Status:</strong> <span className={
                          user.paymentStatus ? "text-green-600" : "text-red-600"
                          }>{paymentStatusLabel(user.paymentStatus)}</span></p>
                        {!user.paymentStatus && (
                          <button
                          type="button"
