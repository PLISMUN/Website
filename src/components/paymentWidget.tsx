        ...
        <section className="bg-muted">
            <div className="mx-auto max-w-4xl px-4 py-4 lg:px-0 min-h-screen">
                <div className="@container lg:col-span-3">
                    ...
                    {process.env.NEXT_PUBLIC_STAGE_CHAIR === "true" && (
                        ...
                        <div className="@md:grid-cols-2 grid gap-3 *:space-y-3 justify-end text-right sm:justify-center sm:text-left">
                            ...
                            <div>
                                <p>
                                    ...
                                    SWIFT: BACXCZPP<br />
                                    Ammount: {paymentInfo?.[0]?.valueCzk ? paymentInfo[0].valueCzk : process.env.NEXT_PUBLIC_PRICE_CZK || 0} CZK<br />
                                </p>
                                {paymentInfo?.[0]?.state && (
                                    <div
                                        style={{
                        ...
                        <div className="@md:grid-cols-2 grid gap-3 *:space-y-3 justify-end text-right sm:justify-center sm:text-left">
                            ...
                            <div>
                                <p>
                                    ...
                                    SWIFT: BACXCZPP<br />
                                    Ammount: €{paymentInfo?.[0]?.valueEur ? paymentInfo[0].valueEur : process.env.NEXT_PUBLIC_PRICE_EUR || 0}<br />
                                </p>
                                {paymentInfo?.[0]?.state && (
                                    <div
                                        style={{
